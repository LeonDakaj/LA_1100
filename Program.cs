namespace Guess_MyNumber_Game
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("In diesem Spiel ist es dein Ziel mit möglichst wenig versuche,meine Zufälig generierte Zahl von 1-100 herauszufinden");
            Console.ForegroundColor = ConsoleColor.White;
            ...
            while (!zahlGefunden || trueFalse)
            {
                ...
                try
                {
                    ...
                    else if (guessNumb == randNumb) // Richtige Zahl eratet
                    {
                        ...
                        Console.WriteLine("Bravo! Du hast meine Zahl eraten!");
                        Console.ForegroundColor = ConsoleColor.White;
                        versueche++;
                        ...
                        Console.Write("Willst du wieder Spielen? [True/False]: ");
                        Console.ForegroundColor = ConsoleColor.White;
                        trueFalse = Convert.ToBoolean(Console.ReadLine());
                ...
                {
                    Console.ForegroundColor = ConsoleColor.DarkRed;
                    Console.WriteLine("UNGÜLTIGE Eingabe. Bitte eine Zahl im Rahmen von 1-100 raten!");
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.WriteLine("--------------------------------");
                    Console.WriteLine("");
                }
